<div class="container">
	<div class="row">
		<div class="col-md-12 row">
			<h2 class="mt-5">La Neumonía en primera persona</h2>
			<div class="col-md-10 offset-1">
				<p class="mt-4 text-justify">La neumonía es una enfermedad del sistema respiratorio que afecta a los pulmones. Las personas de edad avanzada y los niños son los grupos de población más propensos a desarrollarla. Una buena higiene de manos, dejar de fumar y una correcta vacunación, son las medidas básicas para prevenir el contagio de esta infección.</p>
				<p class="mt-4 text-justify">Profesionales y pacientes te explican cómo se convive con la enfermedad</p>
